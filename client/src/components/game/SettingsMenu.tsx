...
export const SettingsMenu: React.FC = () => {
  ...
  const renderKeyBinding = (action: string, displayName: string) => {
    ...
    const keyNames = binding?.keyboard
      .map((key) => KEY_DISPLAY_NAMES[key] || key)
      .join(", ");
        ...
        <div className="settings-group">
          ...
          <div className="slider-container">
            <input
              ...
              onChange={(e) =>
                updatePlayer({ mouseSensitivity: parseFloat(e.target.value) })
              }
            />
        ...
        <div className="settings-group">
          ...
          <div className="slider-container">
            <input
              ...
              onChange={(e) =>
                updatePlayer({
                  gamepadSensitivityX: parseFloat(e.target.value),
                })
              }
            />
        ...
        <div className="settings-group">
          ...
          <div className="slider-container">
            <input
              ...
              onChange={(e) =>
                updatePlayer({
                  gamepadSensitivityY: parseFloat(e.target.value),
                })
              }
            />
      ...
      <div className="settings-tab">
        ...
        <div className="settings-group">
          ...
          <div className="slider-container">
            <input
              ...
              value={fov}
              onChange={(e) =>
                updateGraphics({ fov: parseInt(e.target.value) })
              }
            />
            <span>{fov}°</span>
          </div>
        ...
        <div className="settings-group">
          ...
          <select
            value={shadowQuality}
            onChange={(e) =>
              updateGraphics({ shadowQuality: e.target.value as any })
            }
          >
            <option value="low">Low</option>
            <option value="medium">Medium</option>
        ...
        <div className="settings-group">
          ...
          <input
            ...
            onChange={(e) =>
              updateGraphics({ postProcessing: e.target.checked })
            }
          />
        </div>
          ...
          <>
            <div className="settings-group">
              ...
              <input
                ...
                onChange={(e) =>
                  updateGraphics({ enableVignette: e.target.checked })
                }
              />
            </div>
            ...
            <div className="settings-group">
              ...
              <input
                ...
                onChange={(e) =>
                  updateGraphics({
                    enableChromaticAberration: e.target.checked,
                  })
                }
              />
            </div>
            ...
            <div className="settings-group">
              ...
              <input
                ...
                onChange={(e) =>
                  updateGraphics({ enableBrightnessContrast: e.target.checked })
                }
              />
            </div>
            ...
            <div className="settings-group">
              ...
              <input
                ...
                onChange={(e) =>
                  updateGraphics({ enableToneMapping: e.target.checked })
                }
              />
            </div>
          </>
        ...
        <div className="settings-group">
          ...
          <div className="slider-container">
            <input
              ...
              value={sfxVolume}
              onChange={(e) =>
                updateAudio({ sfxVolume: parseFloat(e.target.value) })
              }
            />
        ...
        <div className="settings-group">
          ...
          <div className="slider-container">
            <input
              ...
              value={musicVolume}
              onChange={(e) =>
                updateAudio({ musicVolume: parseFloat(e.target.value) })
              }
            />
        ...
        <div className="settings-group">
          ...
          <div className="slider-container">
            <input
              ...
              value={ambientVolume}
              onChange={(e) =>
                updateAudio({ ambientVolume: parseFloat(e.target.value) })
              }
            />
      ...
      <div className="settings-tab">
          ...
          <>
            <div className="settings-group">
              ...
              <select
                ...
                onChange={(e) =>
                  updateHUD({ crosshairStyle: e.target.value as any })
                }
              >
        ...
        <div className="settings-group">
          ...
          <input
            ...
            onChange={(e) =>
              updateHUD({ showConnectionStatus: e.target.checked })
            }
          />
        </div>
      </div>
    ...
    >
      ...
      >
        ...
        >
          <button
            className={
              settings.activeSettingsTab === "controls" ? "active" : ""
            }
            style={{
              padding: "12px 24px",
              background: "none",
              border: "none",
              color:
                settings.activeSettingsTab === "controls" ? "white" : "#ccc",
              fontSize: "16px",
              cursor: "pointer",
              position: "relative",
          ...
          <button
            className={
              settings.activeSettingsTab === "graphics" ? "active" : ""
            }
            style={{
              padding: "12px 24px",
              background: "none",
              border: "none",
              color:
                settings.activeSettingsTab === "graphics" ? "white" : "#ccc",
              fontSize: "16px",
              cursor: "pointer",
              position: "relative",
            }}
